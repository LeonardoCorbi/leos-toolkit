...
const Bio: React.FC = () => (
  <>
    <FirstContainer>
      <Animation>
        <div className="line1">
          <span className="pink">let</span>
          {' '}
          leonardoCorbi
          <span className="pink">:</span>
          {' '}
          <span className="purple">Array</span>
          {'<'}
          <span className="orange">any</span>
          {'>'}
          {' '}
          <span className="pink"> = []</span>
        </div>
        <div className="line2">
          leonardoCorbi.
          <span className="green">push</span>
      ...
      <figure>
        <img
          src="../assets/images/LeonardoCorbi.jpg"
    ...
    <ThirdContainer>
      <span
        className="main"
      >
        Algumas ferramentas que eu desenvolvi para me ajudar nos meus processos.
